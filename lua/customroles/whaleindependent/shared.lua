...
ROLE.name = "Independent Whale"
ROLE.nameplural = "Independent Whales"
ROLE.nameext = "an Independent Whale"
ROLE.nameshort = "wlx"

ROLE.desc = [[You are {role}!

You can choose which independent role you are this round!

Right click while holding the Whale Buffet Table to browse what's on offer.]]

ROLE.shortdesc = "Can choose which independent role they are this round."
